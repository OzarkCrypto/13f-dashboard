    ...
    quarters: {
      'Q3 2025': {
        ...
        holdings: [
          ...
          { ticker: 'NVDA', name: 'NVIDIA', value: 354000, shares: 2920000, weight: 4.8, change: '+500%', changeType: 'increased' },
          ...
          { ticker: 'KWEB', name: 'China Internet ETF', value: 190000, shares: 4500000, weight: 2.6, change: '+85%', changeType: 'increased' },
          { ticker: 'FISV', name: 'Fiserv', value: 175000, shares: 870000, weight: 2.4, change: 'NEW', changeType: 'new' },
          { ticker: 'MSFT', name: 'Microsoft', value: 160000, shares: 372000, weight: 2.2, change: '-15%', changeType: 'decreased' },
          { ticker: 'UNH', name: 'UnitedHealth', value: 155000, shares: 270000, weight: 2.1, change: 'NEW', changeType: 'new' },
          { ticker: 'UBER', name: 'Uber', value: 148000, shares: 1950000, weight: 2.0, change: '+25%', changeType: 'increased' },
          { ticker: 'JD', name: 'JD.com', value: 142000, shares: 3200000, weight: 1.9, change: '-10%', changeType: 'decreased' },
          { ticker: 'PDD', name: 'PDD Holdings', value: 130000, shares: 850000, weight: 1.8, change: '-20%', changeType: 'decreased' },
          { ticker: 'GOOGL', name: 'Alphabet A', value: 115000, shares: 470000, weight: 1.6, change: '-30%', changeType: 'decreased' },
          { ticker: 'AAPL', name: 'Apple', value: 110000, shares: 450000, weight: 1.5, change: '-35%', changeType: 'decreased' },
          { ticker: 'V', name: 'Visa', value: 95000, shares: 320000, weight: 1.3, change: 'NEW', changeType: 'new' },
          { ticker: 'TSM', name: 'Taiwan Semi', value: 90000, shares: 320000, weight: 1.2, change: '—', changeType: 'unchanged' },
          { ticker: 'EEM', name: 'EM ETF', value: 85000, shares: 1600000, weight: 1.2, change: '+40%', changeType: 'increased' },
        ],
        newPositions: ['AMD', 'FISV', 'UNH', 'V'],
        exitedPositions: ['AAPL Put', 'WYNN', 'LVS', 'AVGO', 'ORCL', 'INTC'],
      },
      'Q2 2025': {
        totalValue: 6521000,
        totalPositions: 48,
    ...
    quarters: {
      'Q3 2025': {
        ...
        holdings: [
          ...
          { ticker: 'BRKR', name: 'Bruker Pref', value: 13100, shares: 500000, weight: 0.9, change: 'NEW', changeType: 'new' },
        ],
        newPositions: ['PLTR Put', 'NVDA Put', 'PFE Call', 'HAL Call', 'MOH', 'SLM', 'BRKR'],
        exitedPositions: ['UNH', 'REGN', 'META Call', 'EL', 'JD', 'BABA', 'VFC'],
      },
      'Q2 2025': {
        totalValue: 106000,
        totalPositions: 5,
    ...
    quarters: {
      'Q3 2025': {
        ...
        holdings: [
          ...
          { ticker: 'MSFT', name: 'Microsoft', value: 2060000, shares: 4900000, weight: 0.31, change: '+100%', changeType: 'increased' },
          { ticker: 'NVDA', name: 'NVIDIA', value: 1830000, shares: 15100000, weight: 0.28, change: '+21%', changeType: 'increased' },
          { ticker: 'META', name: 'Meta', value: 1440000, shares: 1960000, weight: 0.22, change: '+12693%', changeType: 'increased' },
          { ticker: 'AAPL', name: 'Apple', value: 1250000, shares: 5500000, weight: 0.19, change: '+108%', changeType: 'increased' },
          { ticker: 'V', name: 'Visa', value: 1040000, shares: 3000000, weight: 0.16, change: '+14838%', changeType: 'increased' },
          { ticker: 'GOOGL', name: 'Alphabet A', value: 980000, shares: 5800000, weight: 0.15, change: '+200%', changeType: 'increased' },
          { ticker: 'AMZN', name: 'Amazon', value: 920000, shares: 4200000, weight: 0.14, change: '-40%', changeType: 'decreased' },
          { ticker: 'NSC', name: 'Norfolk Southern', value: 545200, shares: 1900000, weight: 0.08, change: '+18025%', changeType: 'increased' },
          { ticker: 'AVGO', name: 'Broadcom', value: 520000, shares: 2800000, weight: 0.08, change: '+800%', changeType: 'increased' },
          { ticker: 'COST', name: 'Costco', value: 480000, shares: 422240, weight: 0.07, change: '+783%', changeType: 'increased' },
        ],
    ...
    quarters: {
      'Q3 2025': {
        ...
        holdings: [
          ...
          { ticker: 'SPY', name: 'S&P 500 (CALL)', value: 2218000, shares: 3333000, weight: 3.8, change: '+29000%', changeType: 'increased' },
          ...
          { ticker: 'AMZN', name: 'Amazon', value: 175000, shares: 800000, weight: 0.3, change: '+12%', changeType: 'increased' },
          { ticker: 'META', name: 'Meta', value: 165000, shares: 225000, weight: 0.3, change: '+22%', changeType: 'increased' },
          { ticker: 'TSLA', name: 'Tesla', value: 145000, shares: 540000, weight: 0.3, change: '+35%', changeType: 'increased' },
          { ticker: 'FXI', name: 'China Large Cap', value: 120000, shares: 3200000, weight: 0.2, change: '+500%', changeType: 'increased' },
        ],
    ...
    quarters: {
      'Q3 2025': {
        ...
        holdings: [
          ...
          { ticker: 'SOC', name: 'Sable Offshore', value: 18000, shares: 1343000, weight: 0.6, change: '—', changeType: 'unchanged' },
          { ticker: 'AAPL', name: 'Apple', value: 27000, shares: 110500, weight: 0.8, change: '—', changeType: 'unchanged' },
        ],
        newPositions: [],
        exitedPositions: [],
      },
