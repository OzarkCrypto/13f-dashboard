    ...
    quarters: {
      'Q3 2025': {
        ...
        holdings: [
          ...
          { ticker: 'SPY', name: 'S&P 500 ETF', value: 350000, shares: 525000, weight: 5.0, change: '+43%', changeType: 'increased' },
          { ticker: 'FSLR', name: 'First Solar', value: 280000, shares: 1270000, weight: 4.0, change: '-17%', changeType: 'decreased' },
          { ticker: 'IWM', name: 'Russell 2000 ETF', value: 260000, shares: 1075000, weight: 3.7, change: '+1013%', changeType: 'increased' },
          { ticker: 'QQQ', name: 'Nasdaq 100 ETF', value: 240000, shares: 400000, weight: 3.4, change: '+1105%', changeType: 'increased' },
          ...
          { ticker: 'GPN', name: 'Global Payments', value: 200000, shares: 1900000, weight: 2.9, change: '+185%', changeType: 'increased' },
          { ticker: 'NVDA', name: 'NVIDIA', value: 185000, shares: 990000, weight: 2.6, change: '+387%', changeType: 'increased' },
          ...
          { ticker: 'XLP', name: 'Consumer Staples ETF', value: 150000, shares: 1900000, weight: 2.1, change: 'NEW', changeType: 'new' },
          { ticker: 'IBKR', name: 'Interactive Brokers', value: 145000, shares: 980000, weight: 2.1, change: '+820%', changeType: 'increased' },
          { ticker: 'SPOT', name: 'Spotify', value: 140000, shares: 310000, weight: 2.0, change: '+25%', changeType: 'increased' },
          { ticker: 'BRO', name: 'Brown & Brown', value: 135000, shares: 1200000, weight: 1.9, change: '+101%', changeType: 'increased' },
          { ticker: 'DBX', name: 'Dropbox', value: 125000, shares: 4800000, weight: 1.8, change: '+10%', changeType: 'increased' },
          { ticker: 'PCG', name: 'PG&E Corp', value: 120000, shares: 8000000, weight: 1.7, change: '+641%', changeType: 'increased' },
          { ticker: 'XLI', name: 'Industrial ETF', value: 115000, shares: 745000, weight: 1.6, change: 'NEW', changeType: 'new' },
          { ticker: 'CRM', name: 'Salesforce', value: 106000, shares: 450000, weight: 1.5, change: '+5%', changeType: 'increased' },
          { ticker: 'LBRDK', name: 'Liberty Broadband', value: 100000, shares: 1575000, weight: 1.4, change: '-30%', changeType: 'decreased' },
          { ticker: 'AEP', name: 'American Electric', value: 95000, shares: 1000000, weight: 1.4, change: '-36%', changeType: 'decreased' },
          ...
          { ticker: 'IDA', name: 'IDACORP', value: 65000, shares: 620000, weight: 0.9, change: 'NEW', changeType: 'new' },
          { ticker: 'GLXY', name: 'Galaxy Digital', value: 60000, shares: 2500000, weight: 0.9, change: 'NEW', changeType: 'new' },
          { ticker: 'ARMK', name: 'Aramark', value: 55000, shares: 1400000, weight: 0.8, change: 'NEW', changeType: 'new' },
          { ticker: 'TPG', name: 'TPG Inc', value: 52000, shares: 780000, weight: 0.7, change: 'NEW', changeType: 'new' },
          { ticker: 'NXT', name: 'Nextracker', value: 50000, shares: 1100000, weight: 0.7, change: 'NEW', changeType: 'new' },
          { ticker: 'SNAP', name: 'Snap Inc', value: 45000, shares: 5800000, weight: 0.6, change: 'NEW', changeType: 'new' },
          { ticker: 'KODK', name: 'Kodiak AI', value: 42000, shares: 3000000, weight: 0.6, change: 'NEW', changeType: 'new' },
          { ticker: 'CTRI', name: 'Centuri Holdings', value: 40000, shares: 1800000, weight: 0.6, change: 'NEW', changeType: 'new' },
          { ticker: 'TLT', name: 'Treasury Bond ETF', value: 38000, shares: 420000, weight: 0.5, change: '-85%', changeType: 'decreased' },
          { ticker: 'AZN', name: 'AstraZeneca', value: 35000, shares: 550000, weight: 0.5, change: '-70%', changeType: 'decreased' },
          { ticker: 'GS', name: 'Goldman Sachs', value: 32000, shares: 40000, weight: 0.5, change: '-45%', changeType: 'decreased' },
          { ticker: 'ASHR', name: 'China A-Shares ETF', value: 30000, shares: 1100000, weight: 0.4, change: '-73%', changeType: 'decreased' },
        ],
        newPositions: ['RSP', 'XLP', 'XLI', 'FIGR', 'DIS', 'IDA', 'GLXY', 'ARMK', 'TPG', 'NXT', 'SNAP', 'KODK', 'CTRI'],
        exitedPositions: ['ASTS', 'SYRE', 'AFRM', 'ATSG', 'AKAM', 'ALK', 'AA', 'ALKT', 'ALNY', 'GOOG'],
      },
      'Q2 2025': {
        totalValue: 8650000,
        totalPositions: 197,
